                ...
                <div class="container-fluid flex-lg-column align-items-stretch">
                    ...
                    <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                        ...
                        <div class="border bg-light p-3 rounded mb-3">
                            <h6 class="d-flex align-items-center justify-content-between mb-3" style="font-size: 18px;">
                                <span>CHECK AVAILABILITY</span>
                                <button id="chk_avail_btn" onclick="chk_avail_clear()"
                                    class="btn btn-sm btn-outline-dark rounded-0 shadow-none d-none">Reset</button>
                            </h6>
                            <label class="form-label">Check-in</label>
                            <input type="date" class="form-control shadow-none mb-3" id="checkin" value="<?php echo $checkin_default; ?>"
                                onchange="chk_avail_filter()" />
                            <label class="form-label">Check-out</label>
                            <input type="date" class="form-control shadow-none" id="checkout" value="<?php echo $checkout_default; ?>"
                                onchange="chk_avail_filter()" />
                        </div>
                        ...
                        <div class="border bg-light p-3 rounded mb-3">
                            ...
                            <div class="d-flex">
                                <div class="me-3">
                                    ...
                                    <input type="number" min="1" id="adults" oninput="guests_filter()" value="<?php echo $adult_default; ?>"
                                        class="form-control shadow-none">
                                </div>
                                <div class="">
                                    <label class="form-label">Children</label>
                                    <input type="number" min="1" id="children" oninput="guests_filter()" value="<?php echo $children_default; ?>"
                                        class="form-control shadow-none">
                                </div>
                            </div>
                        </div>
