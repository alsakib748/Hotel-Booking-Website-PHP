...
if (!isset($_GET['id']) || empty($_GET['id']) || $settings_r['shutdown'] == true) {
    redirect("rooms.php");
                    ...
                    <form action="pay_now.php" method="POST" id="booking_form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <button name="pay_now"
                                    class="btn w-100 text-white custom-bg shadow-none mb-1 disabled">Pay
                                    Now</button>
                            </div>
                        </div>
                    </form>
...
<script>
    ...
    function check_availability() {
        ...
        booking_form.elements['pay_now'].classList.add("disabled");
        ...
        if (checkin_val != '' && checkout_val != '') {
            ...
            xhr.onload = function () {
                ...
                if(data.status == 'check_in_out_equal'){
                    ...
                    booking_form.elements['pay_now'].classList.remove("disabled");
                }
