...
if(isset($_POST['edit_room'])){
    ...
    $del_features = delete_fun("DELETE FROM `room_features` WHERE `room_id`=?",[$frm_data['room_id']],'i');
    $del_facilities = delete_fun("DELETE FROM `room_facilities` WHERE `room_id`=?",[$frm_data['room_id']],"i");
...
if(isset($_POST['remove_room'])){
    ...
    $res2 = delete_fun("DELETE FROM `room_images` WHERE `room_id`=?",[$frm_data['room_id']],'i');
    $res3 = delete_fun("DELETE FROM `room_features` WHERE `room_id`=?",[$frm_data['room_id']],'i');
    $res4 = delete_fun("DELETE FROM `room_facilities` WHERE `room_id`=?",[$frm_data['room_id']],'i');
    $res5 = delete_fun("UPDATE `rooms` SET `removed`=? WHERE `id`=?",[1,$frm_data['room_id']],'ii');
