        ...
        <div class="swiper-wrapper">
            ...
            while ($row = mysqli_fetch_assoc($res)) {
                ...
                echo <<<data
                    ...
                    <img src="$path$row[image]" class="img-fluid w-100 carousel-height d-block" />
                    </div>
                    data;
            }
            ?>
...
<div class="container">
    <div class="row">
        ...
        while ($room_data = mysqli_fetch_assoc($room_res)) {
            ...
            $fea_q = mysqli_query($con, "SELECT features.name FROM `features` INNER JOIN `room_features` ON features.id = room_features.features_id WHERE room_features.room_id = '$room_data[id]'");
            $features_data = "";
            ...
            $fac_q = mysqli_query($con, "SELECT facilities.name FROM facilities INNER JOIN room_facilities ON facilities.id = room_facilities.facilities_id WHERE room_facilities.room_id = '$room_data[id]'");
            $facilities_data = "";
            ...
            echo <<<data
                ...
                <div class="card border-0 shadow" style="max-width: 350px;margin: auto;">
                    <img src="$room_thumb" class="card-img-top card-img-height">
                ...
                if (!$settings_r['shutdown']) {
                    ...
                    echo "<button onclick='checkLoginToBook($login,$room_data[id])' class='btn btn-sm text-white custom-bg shadow-none'>Book Now</button>";
                }
...
<div class="container">
    ...
    <div class="swiper swiper-testimonials">
        <div class="swiper-wrapper mb-5">
            <?php
            $review_q = "SELECT rr.*,uc.name AS uname,uc.profile,r.name AS rname FROM `rating_review`as rr INNER JOIN `user_cred` as uc ON rr.user_id = uc.id INNER JOIN `rooms` as r ON rr.room_id = r.id ORDER BY `sr_no` DESC LIMIT 10";
