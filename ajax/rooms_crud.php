...
if (isset($_GET['fetch_rooms'])) {
    ...
    /// count no. of rooms and output website is shutdown or not
    $count_rooms = 0;
    $output = '';
    ...
    while ($room_data = mysqli_fetch_assoc($room_res)) {
        ...
        $fac_count = 0;
        $fac_q = mysqli_query($con, "SELECT facilities.name,facilities.id FROM facilities INNER JOIN room_facilities ON facilities.id = room_facilities.facilities_id WHERE room_facilities.room_id = '$room_data[id]' ");
        $facilities_data = '';
            ...
            <div class='card mb-4 border-0 shadow'>
                <div class='row g-0 p-3 align-items-center'>
                    <div class='col-md-5 mb-lg-0 mb-md-0 mb-3'>
                        <img src='$room_thumb' class='w-100 img-fluid rounded'>
                    </div>
