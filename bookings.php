            ...
            if ($data['booking_status'] == 'booked') {
                ...
                if ($data['arrival'] == 1) {
                    ...
                    if ($data['rate_review'] == 0) {
                        $btn .= "<button type='button' onclick='review_room($data[booking_id],$data[room_id])' class='btn btn-dark btn-sm shadow-none ms-2' data-bs-target='#reviewModal' data-bs-toggle='modal' data-bs-dismiss='modal' >Rate & Review</button>";
                    }
                } else {
            ...
            <form action="" method="POST" id="review-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control shadow-none" name="review" rows="3" required></textarea>
                    </div>
